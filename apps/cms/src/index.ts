...
} from "./collections/brands/config";
...
import { initializeOpenAI } from "./common/openai";
import { initializeTranslator } from "./common/translation";
...
export * from "./collections/brands/migrate-home-links-to-root-paths";
export * from "./collections/brands/migrate-theme-colors";
export * from "./collections/media/migrate-categories-to-folders";
...
export const cmsPlugin =
  ...
  (config: Config) => {
    ...
    config.admin.components.beforeNavLinks = [
      "/src/components/rsc#VersionInfo",
    ];
