...
import type { TranslationsKey } from "../../translations/types";

import { pathnameBelongsToRootPath } from "../../common/pathname";
import { getPageBrandId } from "../brands/home-link";
import {
  getMostSpecificBrandForPathname,
  resolveRootPathForLocale,
} from "../brands/root-path";
import { getPagesForPathname } from "./localized-pathname";
  ...
  return [
    {
      ...
      admin: {
        components: {
          Field: "/src/components/client#PathnameField",
        },
        description: {
